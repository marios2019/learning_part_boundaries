...
class Dataset():
	def __init__(self, pc_dataset_dir='', split='', sampling=True, npoints=10000, normalize=True, nrotations=1,
				 random_rotation=False, rotate_principals_around_normal=False, return_weights=False):
		...
		print("Return weights: {ret_weights:s}".format(ret_weights=str(self.return_weights)))
